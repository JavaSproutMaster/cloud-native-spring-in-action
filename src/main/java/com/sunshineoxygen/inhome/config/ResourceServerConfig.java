...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http
				...
				.antMatchers("/api/auth/createdoctor").permitAll()
				.antMatchers("/api/auth/user/resetpassword").permitAll()
				.antMatchers("/api/auth/doctor/resetpassword").permitAll()
				.antMatchers("/api/auth/updatepassword").permitAll()
				.antMatchers("/api/auth/credential/user/otp").permitAll()
				.antMatchers("/api/auth/credential/doctor/otp").permitAll()
				.antMatchers("/api/auth/credential/user/verifyotp").permitAll()
				.antMatchers("/api/auth/credential/doctor/verifyotp").permitAll()
